...
- A numbered navigation bar and flow strip at the top make the Pages and self-hosted dashboards follow the workshop sequence—connect, load templates, set workshops, assign RACI, validate, and export—so users always know where they are in the process.
